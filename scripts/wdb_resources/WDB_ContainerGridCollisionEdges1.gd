class_name WDB_ContainerGridCollisionEdges1 extends WDB_DataContainer
...
func LoadFromBuffer(file : StreamPeerBuffer, loader : WDB_FileLoader) -> void:
	...
	super(file, loader)
	self.name = WDB_ASCIIZ.ApplyName(self.object_name, "GridCollisionEdges1_%s" % self.offset_hex)
